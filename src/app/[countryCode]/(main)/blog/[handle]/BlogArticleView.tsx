...
import type { MedusaArticle, TocItem } from "@lib/blog"
...
type BlogArticleViewProps = {
  ...
  authorName: string
  prevArticle: MedusaArticle | null
  nextArticle: MedusaArticle | null
  relatedArticles: MedusaArticle[]
}
      ...
      <main className="min-h-screen bg-white font-sans selection:bg-[#5A1216] selection:text-white pt-24 md:pt-32 pb-0 text-[#111]">
        ...
        <div className="flex flex-col-reverse lg:flex-row max-w-[1400px] mx-auto relative items-start mb-20">
          <article className="w-full lg:w-[70%] px-6 lg:px-12 lg:pr-20">
            ...
            <div
              className="w-full max-w-none text-[#222] text-[15px] leading-[1.8] md:leading-[2.0] tracking-[0.05em] [&_p]:mb-6 [&_h2]:text-[22px] md:[&_h2]:text-[28px] [&_h2]:font-extrabold [&_h2]:leading-[1.3] [&_h2]:text-black [&_h2]:mt-16 [&_h2]:mb-6 [&_h3]:text-[18px] md:[&_h3]:text-[20px] [&_h3]:font-bold [&_h3]:text-black [&_h3]:pt-8 [&_h3]:mt-12 [&_h3]:mb-4 [&_h3]:border-t [&_h3]:border-dashed [&_h3]:border-gray-300 [&_img]:w-full [&_img]:my-12 [&_img]:object-cover [&_img]:rounded-xl [&_img]:shadow-sm [&_blockquote]:border-l-[6px] [&_blockquote]:border-[#7B1D23] [&_blockquote]:pl-6 [&_blockquote]:py-4 [&_blockquote]:text-[#4A4A4A] [&_blockquote]:my-8 [&_blockquote]:bg-[#FAFAFA] [&_blockquote]:font-medium [&_blockquote]:text-[14px] [&_ul]:list-disc [&_ul]:pl-6 [&_li]:my-2 [&_a]:text-[#5A1216] [&_a]:underline [&_a]:underline-offset-4 hover:[&_a]:text-[#D4AF37] [&_a]:transition-colors"
                ...
                {relatedArticles.map((relArticle) => (
                  ...
                  >
                    ...
                    <p className="text-xs text-gray-400 mb-2">
                      {formatArticleDate(relArticle.created_at)}
                    </p>
