  ...
  return (
    <div className="w-full bg-[#FDF5E6]/30 font-sans overflow-hidden">
      ...
      <section className="py-20 md:py-24 px-6 md:px-12 max-w-[1400px] mx-auto border-b border-[#D4AF37]/10">
        {/* (如果你的程式碼中原本有渲染 PROCESS_STEPS 的排版，可以加在這裡) */}

        {/* 為什麼需要熔融檢測 (信任感保證區塊) */}
        <div className="mt-16 bg-gradient-to-br from-[#5A1216] to-[#3A0A0E] p-8 md:p-12 lg:p-16 shadow-2xl relative overflow-hidden rounded-2xl">
          {/* 背景裝飾 */}
          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="rounded-2xl overflow-hidden shadow-lg border border-white/10 aspect-video lg:aspect-[4/3]">
              <img
                src="/images/18e59f52-18b7-413b-a783-ff21e3c51ad3.png" // 🚀 使用你指定的圖片
                alt="安心保障"
